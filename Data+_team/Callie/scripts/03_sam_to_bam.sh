...
#SBATCH --array=1-18
#SBATCH --output=/work/clh162/OysterRNA24/logs/sam_to_bam_%A_%a.out
#SBATCH --error=/work/clh162/OysterRNA24/logs/sam_to_bam_%A_%a.err
...
## Set Paths ##
SAM_DIR=/work/clh162/OysterRNA24/hisat2_align/alignedreads
